...
(function() {
  ...
  module.exports = FreeSwitchParser = (function() {
    ...
    FreeSwitchParser.prototype.capture_body = function(data) {
      ...
      this.headers = {};
      return this.capture_headers(new Buffer(0));
    };
    ...
    FreeSwitchParser.prototype.capture_headers = function(data) {
      ...
      if (this.headers["Content-Length"]) {
        ...
        return this.capture_body(new Buffer(0));
      } else {
    ...
    FreeSwitchParser.prototype.on_end = function() {
      if (this.buffer_length > 0) {
        return this.socket.emit('error', new FreeSwitchParserError('Buffer is not empty at end of stream', this.buffer));
      }
    };
